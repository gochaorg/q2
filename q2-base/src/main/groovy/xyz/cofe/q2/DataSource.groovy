...
/**
 * <p>Набор данных / Истоничк данных
 *
 * <ul>
 *   <li> Источник данных испольюзет в качестве входных значений - итератор.
 *   <li> Источник данных - не модифицирует данные
 *   <li> Источник данных производит другие источники, с разными алгоримами итерации по данным
 *   , см {@link It}
 * </ul>
 */
class DataSource<T> implements Iterable<T> {
    /**
     * Итератор по исходному набору данных
     */
